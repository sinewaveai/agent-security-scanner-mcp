...
function parseYaml(filePath) {
  // Lightweight version: YAML config not supported, use JSON instead
  console.error('Warning: YAML config files not supported in lightweight version. Use .scannerrc.json instead');
  return null;
}
